...
<html ng-app="parser">
    <head>
        ...
        <title>Palabra Modificada</title>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success" role="alert">
                        <h4 class="alert-heading">¡Palabra modificada!</h4>
                        <p>Se ha modificado la palabra correctamente</p>
                        <hr>
                    </div>
                    <form action="<%=request.getContextPath()%>/ModifyServlet" method="get">
