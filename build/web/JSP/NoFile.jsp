        ...
        <div id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <h1>Error al subir el fichero</h1>
                    <% if (session.getAttribute("Admin") != null) {%>
                    <h2>Bienvenido/a <%=session.getAttribute("Admin")%></h2>
                    <%} else {%>
                    <h2>Bienvenido/a <%=session.getAttribute("User")%></h2><% }%>
                    <div class="alert alert-danger" role="alert">
                        <h4 class="alert-heading">¡No se ha seleccionado ningún fichero!</h4>
                        <p>Debes seleccionar un fichero para analizar</p>
                        <hr>
                    </div>
